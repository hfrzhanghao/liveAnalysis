...
/*	 for(a1){
			 for(listQu){
				 boolean aboutlost = false;
				 if("lostType".equals("gt")){
					 aboutlost = a1.lost > "lost";
				 }
				 
				 boolean aboutdelay = false;
				 if("delayType".equals("gt")){
					 aboutlost = a1.lost > "lost";
				 }
				 
				 boolean aboutConnector = false;
				 
				 if("connector".equals("and")){
					 aboutConnector = aboutlost &&  aboutlost;
				 }
